    ...
    <Header/>
        <div className="lollyFormDiv"> 
            ...
            <div className="lollyFlavourDiv">
                ...
                <input type="color" value={color3} className="colorPicker" name="flavourTop" id="flavourTop" onChange={(e)=>{
            ...
            <div> 
                ...
                <label htmlFor="recipientName"> 
                    ...
                    <textarea row="15" column="30" ref={messageRef}/>
                    <label htmlFor="recipientName"> 
                       From  
                    </label>
                    <input type="text" name="senderName" id="recipientName" ref={senderRef}/>
                </div>
                <input type="button" value="Create Lollypop" onClick={submitLollyForm} />  
            </div>
        </div>
    </div>
